...
class MosaicCollectionViewLayout: UICollectionViewLayout {
    ...
    /// - Tag: PrepareMosaicCollectionViewLayout
    override func prepare() { //Tells the layout object to update the current layout.
        super.prepare()
    ...
    //MARK: Every layout object should implement the following methods:
    ...
    ///layoutAttributesForDecorationView(ofKind:at:) (if your layout supports decoration views), shouldInvalidateLayout(forBoundsChange:)
